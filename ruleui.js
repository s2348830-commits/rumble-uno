...
window.CUSTOM_CARDS_DEF = [
    ...
    { id: 'bara1', name: '赤バラ', desc: '【AT】自分以外のランダムなプレイヤーに固定で3枚ドローさせる。(防御不可)', type: 'AT' },
    { id: 'bara2', name: '桃バラ', desc: '【HE】使用後自分にシールドIIIを3ターン付与する。', type: 'HE' },
    { id: 'bara3', name: '白バラ', desc: '【HE】70%の確率で赤バラと桃バラのカード両方を手札に加える。外れた場合カードを1枚引く。', type: 'HE' }
];
