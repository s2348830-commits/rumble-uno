...
window.handleEndTurnClick = function(e) {
    ...
    if (window.isHost) {
        ...
        setTimeout(() => { window.waitingForServerResponse = false; window.isProcessingPlay = false; }, 2000);
    }
};

// 画面全体のクリックを監視し、IDが合致した時だけ1度だけ処理を呼ぶ（重複を完全無視）
